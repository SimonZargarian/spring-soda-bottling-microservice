...
public class SodaPagedList extends PageImpl<SodaDto> implements Serializable {

    static final long serialVersionUID = 1114715135625836949L;

    @JsonCreator(mode = JsonCreator.Mode.PROPERTIES)
    public SodaPagedList(@JsonProperty("content") List<SodaDto> content,
